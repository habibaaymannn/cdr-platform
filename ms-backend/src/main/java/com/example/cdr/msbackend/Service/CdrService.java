...
import com.example.cdr.msbackend.Service.Validation.CdrValidationStrategy;
...
public class CdrService {
    ...
    private CdrValidationStrategy cdrValidationStrategy;

    public CdrService(CdrMapper cdrMapper, CdrRepository cdrRepository, CdrValidationStrategy cdrValidationStrategy) {
        this.cdrMapper = cdrMapper;
        this.cdrRepository = cdrRepository;
        this.cdrValidationStrategy = cdrValidationStrategy;
    }
    ...
    public Cdr validateAndCreate(CdrDTO dto) {
        ...
        cdrValidationStrategy.validateCdr(cdr);
